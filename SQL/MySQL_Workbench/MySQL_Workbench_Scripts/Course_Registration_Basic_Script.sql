...
-- -----------------------------------------------------
-- Table `mydb`.`courseRoster`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`courseRoster` (
  ...
  INDEX `fk_Courses_has_Students_Courses1_idx` (`Courses_courseID` ASC) VISIBLE,
